 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Kyrsten"); //person1
		  toPrint += p1.toString("kgreenfield3");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Joseph");
		  toPrint += p2.toString("jhooper8");
		  ...
		  toPrint += p3.toString("gburdell3");
                  ...
                  Person5 p5 = new Person5("Hyunook Kwon");
                  toPrint += p5.toString("hkwon62");
